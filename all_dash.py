...
<body>
            ...
            <div class="card">
                ...
                <div class="station-grid">
                    ...
                    <div class="station-card" id="station-S2">
                        ...
                        <div style="color: #4a5568; margin-bottom: 15px; font-style: italic;">
                            Automated Bearing Press & Linear Rail Alignment
                        </div>
                        <div class="slider-container">
                            <label>
                                <span>Cycle Time (s)</span>
                    ...
                    <div class="station-card" id="station-S3">
                        ...
                        <div style="color: #4a5568; margin-bottom: 15px; font-style: italic;">
                            Smart Torque Drivers & Nutrunners - 6-10 units
                        </div>
                        <div class="slider-container">
                            <label>
                                <span>Cycle Time (s)</span>
                    ...
                    <div class="station-card" id="station-S4">
                        ...
                        <div style="color: #4a5568; margin-bottom: 15px; font-style: italic;">
                            Cable Harness Crimping & Looping Machine
                        </div>
                        <div class="slider-container">
                            <label>
                                <span>Cycle Time (s)</span>
                    ...
                    <div class="station-card" id="station-S5">
                        ...
                        <div style="color: #4a5568; margin-bottom: 15px; font-style: italic;">
                            Gantry Run-in and Measurement Fixture
                        </div>
                        <div class="slider-container">
                            <label>
                                <span>Cycle Time (s)</span>
                    ...
                    <div class="station-card" id="station-S6">
                        ...
                        <div style="color: #4a5568; margin-bottom: 15px; font-style: italic;">
                            Machine Vision System + Automated Box Sealer
                        </div>
                        <div class="slider-container">
                            <label>
                                <span>Cycle Time (s)</span>
    ...
    <script>
        ...
        function updateStationTable(data) {
            ...
            const stations = [
                {id: 'S1', name: 'Precision Assembly (Cobots)', util: data.s1_util || 78.5, cycle: data.s1_cycle || 9.6, 
                 failure: (data.s1_failure || 0.02) * 100, mttr: data.s1_mttr || 30},
                {id: 'S2', name: 'Motion Control Assembly', util: data.s2_util || 85.2, cycle: data.s2_cycle || 12.3, 
                 failure: (data.s2_failure || 0.05) * 100, mttr: data.s2_mttr || 45},
                {id: 'S3', name: 'Fastening Quality Control', util: data.s3_util || 89.7, cycle: data.s3_cycle || 8.7, 
                 failure: (data.s3_failure || 0.03) * 100, mttr: data.s3_mttr || 25},
                {id: 'S4', name: 'Cable Management System', util: data.s4_util || 98.7, cycle: data.s4_cycle || 15.2, 
                 failure: (data.s4_failure || 0.08) * 100, mttr: data.s4_mttr || 60},
                {id: 'S5', name: 'Initial Testing & Calibration', util: data.s5_util || 76.3, cycle: data.s5_cycle || 6.4, 
                 failure: (data.s5_failure || 0.01) * 100, mttr: data.s5_mttr || 15},
                {id: 'S6', name: 'Final QC & Packaging', util: data.s6_util || 82.1, cycle: data.s6_cycle || 10.1, 
        ...
        function getBottleneckRecommendations(station, utilization) {
            ...
            if (station === 'S1') {
                recommendations = `
                    ...
                    <li style="margin-bottom: 8px;">Implement vision-guided placement to reduce cycle time by 10%</li>
                    <li style="margin-bottom: 8px;">Increase S1→S2 buffer to 8-10 units</li>
                `;
            } else if (station === 'S2') {
                recommendations = `
                    ...
                    <li style="margin-bottom: 8px;">Increase S1→S2 buffer from 5 to 8-10 units</li>
                    <li style="margin-bottom: 8px;">Implement predictive maintenance for press alignment</li>
                `;
            } else if (station === 'S3') {
                recommendations = `
                    <li style="margin-bottom: 8px;">Add 2 more smart torque stations (increase from 6-10 to 8-12 units)</li>
                    <li style="margin-bottom: 8px;">Implement real-time torque monitoring with IoT sensors</li>
                    <li style="margin-bottom: 8px;">Reduce changeover time with quick-release tooling</li>
                    <li style="margin-bottom: 8px;">Increase S2→S3 buffer to 8-10 units</li>
                `;
            } else if (station === 'S4') {
                recommendations = `
                    <li style="margin-bottom: 8px;">Add parallel cable crimping machine (reduce bottleneck by 35%)</li>
                    <li style="margin-bottom: 8px;">Reduce cycle time from 15.2s → 12.0s via thermal chamber upgrade</li>
                    <li style="margin-bottom: 8px;">Increase S3→S4 buffer to 12-15 units (currently ${document.getElementById('buffer34').value})</li>
                    <li style="margin-bottom: 8px;">Implement predictive maintenance for crimping heads</li>
                    <li style="margin-bottom: 8px;">ROI: 8.2 months payback period at $22/unit margin</li>
                `;
            } else if (station === 'S5') {
                recommendations = `
                    <li style="margin-bottom: 8px;">Add one more test fixture (increase from 2 to 3 units)</li>
                    <li style="margin-bottom: 8px;">Optimize test sequence - parallel testing where possible</li>
                    <li style="margin-bottom: 8px;">Upgrade laser sensors for 20% faster measurement</li>
                    <li style="margin-bottom: 8px;">Increase S4→S5 buffer to 8-10 units</li>
                `;
            } else if (station === 'S6') {
                recommendations = `
                    <li style="margin-bottom: 8px;">Add automated palletizing system to reduce packaging time</li>
                    <li style="margin-bottom: 8px;">Upgrade vision system for 30% faster inspection</li>
                    <li style="margin-bottom: 8px;">Implement batch packaging to reduce cycle time by 15%</li>
    ...
    try:
        ...
        if "buffers" in data:
            ...
            for buffer_key, buffer_value in data["buffers"].items():
                config["buffers"][buffer_key] = buffer_value
